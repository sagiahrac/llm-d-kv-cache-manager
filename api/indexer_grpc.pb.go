...
func (c *indexerServiceClient) GetPodScores(ctx context.Context, in *GetPodScoresRequest, opts ...grpc.CallOption) (*GetPodScoresResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPodScoresResponse)
	err := c.cc.Invoke(ctx, IndexerService_GetPodScores_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIndexerServiceServer) GetPodScores(context.Context, *GetPodScoresRequest) (*GetPodScoresResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPodScores not implemented")
}
...
func _IndexerService_GetPodScores_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPodScoresRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IndexerServiceServer).GetPodScores(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IndexerService_GetPodScores_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndexerServiceServer).GetPodScores(ctx, req.(*GetPodScoresRequest))
	}
